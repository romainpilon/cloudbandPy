...
if __name__ == "__main__":
    ...
    list_of_cloud_bandsSP_djfm = load_multiyears_data(config, varname="list_of_cloud_bands")
    ...
    figurename = f"{config['dir_figures']}/histogram_cb_{config['startdate'][:4]}_{config['enddate'][:4]}_fullmonth_vs_djfm_{config['domain']}.png"
